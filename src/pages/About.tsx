      ...
      <section className="py-20 bg-gradient-sunset text-center">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl md:text-2xl text-white/90 leading-relaxed animate-slide-up">
            The authentic taste of Maharashtra, crafted with love
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="font-serif text-4xl font-bold text-foreground mb-6">
                A Legacy of
                <span className="text-gradient block">Taste and Quality</span>
              </h2>
              <div className="space-y-6 text-muted-foreground leading-relaxed">
                <p>
                  Vinayak Foods began as a humble kitchen where our aai,
                  would prepare traditional Maharashtrian delicacies for 
                  festivals and special occasions. Her recipes,
                  carried the essence of love and the feeling of closeness.
                </p>
                <p>
              ...
              <Card className="card-warm">
                <CardContent className="p-8">
                  ...
                  <footer className="mt-6">
                    <p className="font-semibold text-foreground">- Vinayak Foods</p>
                    <p className="text-sm text-muted-foreground">Traditional Maharastrian Foods</p>
                  </footer>
                </CardContent>
              </Card>
            </div>
