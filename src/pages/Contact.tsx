              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Button 
                    ...
                    onClick={() => window.open('tel:9324486528')}
                  >
                    Call 9324486528
                  </Button>
                </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Button 
                    ...
                    onClick={() => openWhatsApp('9324486528')}
                  >
                    WhatsApp 9324486528
                  </Button>
                </div>
            ...
            <Card className="card-warm text-center group md:col-span-2 lg:col-span-1">
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Home Delivery Available In mumbai</p>
                </div>
                <p className="text-muted-foreground text-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center py-2 border-b border-border/50">
                    ...
                    <span className="text-primary font-semibold">10:00 AM - 7:00 PM</span>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3 text-muted-foreground">
                    ...
                    <p className="flex items-start">
                      <span className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0"></span>
                      Order 2 days before the date you want your order
                    </p>
                    <p className="flex items-start">
                      <span className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0"></span>
