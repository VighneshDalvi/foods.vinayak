...
const testimonials = [
  {
    ...
    location: "Mumbai",
    rating: 5,
    review: "The Ukdiche Modak from Vinayak Foods tastes exactly like my mother used to make! The authenticity is unmatched, and the delivery was prompt. Highly recommended for anyone craving genuine Maharashtrian flavors.",
    item: "Ukdiche Modak",
    date: "2 weeks ago"
  },

  {
    ...
    location: "Mumbai",
    rating: 5,
    review: "The Dinkache Ladoo are a powerhouse of nutrition and taste! Fresh ingredients, authentic preparation, and excellent packaging. Thank you Vinayak Foods!",
    item: "Dinkache Ladoo",
    date: "3 weeks ago"
  },
  {
    ...
    location: "Mumbai",
    rating: 5,
    review: "Kothimbir Vadi with evening tea is pure bliss! Crispy, flavorful. With mint chutney was an excellent complement. Outstanding quality!",
    item: "Kothimbir Vadi",
    date: "1 week ago"
  }
];
