...
const menuItems = [
  ...
  },
  {
    id: 2,
    name: "Dinkache Ladoo",
    description: "Nutritious edible gum laddoos packed with premium dry fruits. Made with dink, ghee, almonds, cashews, and dates. Perfect for new mothers and winter wellness. A powerhouse of nutrition wrapped in sweetness.",
    price: "₹120",
    per: "per kg",
    image: dinkacheLadoo,
    vegetarian: true,
      ...
      <section className="py-20 bg-gradient-sunset text-center">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl md:text-2xl text-white/90 leading-relaxed animate-slide-up">
            Perfected with love and tradition
          </p>
        </div>
      </section>
