...
const Navigation = () => {
  ...
  <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-primary flex items-center justify-center shadow-md">
    <img 
      src="https://img.freepik.com/premium-vector/lord-ganesha-symbol-logo-design-with-tattoo-style_428817-1124.jpg?w=2000" 
      alt="Ganesha Logo" 
      className="w-full h-full object-cover"
    />
  </div>
  <div>
    <h2 className="font-serif font-bold text-xl text-gradient">Vinayak Foods</h2>
